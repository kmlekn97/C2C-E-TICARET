...
<?php 
$siparissor=$dbservice->Iade_durum();
?>
          ...
          <div class="tab-pane fade active in" id="Personal">
            ...
            <div class="personal-info inner-page-padding"> 
                ...
                <tbody>
                  ...
                  while($sipariscek=$dbservice->vericek($siparissor)) {
                    ...
                    if ($iadelerim->get_iade_durum()==1 || $iadelerim->get_iade_durum()==2 || $iadelerim->get_iade_durum()==3) {
                      ...
                      echo $siparis_detaylarim->get_kargo_no();
              ...
              if ($iadelerim->get_iade_durum() != 0)
              {
                ...
                echo "<td>";
                $formpanel->Button_Href("Fatura","fatura/iade-kullanici-fatura.php?siparis_zaman=".$siparislerim->get_siparis_zaman()."&kullanici_id=".$sipariscek['k_id']."&skullanici_id=".$sipariscek['ks_id']."&siparis_id=".$siparislerim->get_siparis_id(),"success");
                echo "</td>";
