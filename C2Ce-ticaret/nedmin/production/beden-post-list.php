...
$urunsor=$admindbservices->bedenPostIslem($renkgelen,$beden);
...
<table id="icdata" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      $tbl->AddDurum($uruncek['urun_durum'],11);
      $tbl->AddButton("urun-duzenle.php?urun_id=".$Urunlerim->get_urun_id(),12,"Düzenle","primary");
      $tbl->AddButton("../netting/islem.php?urun_id=".$Urunlerim->get_urun_id()."&urunfoto_resimyol=".$Urunlerim->get_urunfoto_resimyol()."&adminurunsil=ok",13,"Sil","danger");
      ?>
    </tr>
