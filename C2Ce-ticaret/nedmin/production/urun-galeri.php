    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_title">
             <div align="left" class="col-md-6">
              <h2 >Resim Ürün Fotoğraf İşlemleri <small>
                ...
                $sorgu=$admindbservices->UrunFotoGetir();
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                ...
                $urunfotolist=$admindbservices->UrunFotoListele($_GET['urun_id'],$limit,$sayfada);
                $urunfotolist=$urunfotolist->toArray();
                foreach ($urunfotolist as $foto) 
                {
                  ...
                  <div class="col-md-55">
                   <label>
                    <div class="image view view-first">
                      ...
                      <div class="mask">
                        <p><?php echo $urunfotocek['urunfoto_ad']; ?> <?php echo $foto->get_urunfoto_id(); ?></p>
                    ...
                    <input type="checkbox" name="urunfotosec[]" id="urunfotosecyol[]"  value="<?php echo  $foto->get_urunfoto_id();  $foto->get_urunfoto_resimyol(); ?>" > Seç
                  </label>
