...
class Kampanya
{
	...
	private $kampanya_id;
	private $kampanya_adi;
	private $kampanya_aciklama;
	private $kampanya_oran;
	private $kampanya_logo;
	private $kampanyabaslangic_tarihi;
	private $kampanyabitis_tarihi;
	private $kategori_id;
	private $durum;
	private $kullanici_id;
	
	function __construct($kampanya_id,$kampanya_adi,$kampanya_aciklama,$kampanya_oran,$kampanya_logo,$kampanyabaslangic_tarihi,$kampanyabitis_tarihi,$kategori_id,$durum,$kullanici_id)
	{
		// code...
