...
class Alt_kategori_ozellik_detay extends Alt_kategori_ozellik
{
	private $ozellik_detay_id;
	private $ozellik_detay;

	function __construct($ozellik_detay_id,$ozellik_detay,$urun_ozellikleri_id,$alt_kategori_detay_id,$ozellik_adi,$ozellik_durum,$kullanici_id)
	{
		// code...
