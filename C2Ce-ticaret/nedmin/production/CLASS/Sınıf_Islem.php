...
require_once 'CLASS/Urun_Ozellik.php';
...
class Sınıf_Islem
{
	...
	{
		$this->kategorim=new Kategori($vericek['kategori_id'],$vericek['kategori_ad'],$vericek['kategori_oran'],$vericek['kategori_onecikar'],$vericek['kategori_seourl'],$vericek['kategori_sira'],$vericek['kategori_durum'],$vericek['kullanici_id']);
	...
	{
		$this->urun_ozellik=new Urun_Ozellik($vericek['urun_ozellikleri_id'],$vericek['alt_kategori_detay_id'],$vericek['ozellik_adi'],$vericek['ozellik_durum'],$vericek['kullanici_id']);
