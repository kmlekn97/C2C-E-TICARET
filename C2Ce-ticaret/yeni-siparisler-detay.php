...
$siparissorkargo=$dbservice->yenisiparisdetaygetir();
            ...
            <div class="personal-info inner-page-padding"> 
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php 
                  $siparissor=$dbservice->yenisiparisdetaygetir();
                  ...
                  while($sipariscek=$dbservice->vericek($siparissor)) { 
                    ...
                    } else if ($siparis_detaylarim->get_siparisdetay_onay()==1) {?>

                      <button class="btn btn-success btn-xs"> Ürün İşlemleri Yapılıyor</button>
