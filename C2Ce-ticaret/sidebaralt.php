  ...
  <div class="sidebar-item" style="width: 115%">
    <div class="sidebar-item-inner">
      ...
      <ul class="sidebar-categories-list">
       ...
       $uruncek=$dbservice->sidealturungetir();
       ...
       $altkategoridetaylist=$dbservice->sidealtkategoridetayListele();
    ...
    <section  class="sky-form">
      ...
      <div class="marka-row">
        <div class="row1 scroll-pane">
         ...
         $markasor=$dbservice->sidebaraltmarkalistele($uruncek['kategori_id']);
