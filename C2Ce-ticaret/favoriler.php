					...
					<div class="tab-pane fade active in" id="Personal">
						...
						<div class="personal-info inner-page-padding"> 
							...
							<table class="table table-striped">
								...
								<tbody>
									<?php 
									$arraylistfavori=array();
									$favorilist=new ArrayList($arraylistfavori);
									$favorilist=$dbservice->FavoriListeleme();
									$favorilist=$favorilist->toArray();
									foreach ($favorilist as $urunlerim) 
									{
										...
										<tr>
											...
											<td style="width: 10%"> <img src="<?php echo $urunlerim->get_urunfoto_resimyol();?>" alt="<?php echo $urunlerim->get_urun_ad();?>" class="img-responsive"/>
										...
										<td>
											...
											$formpanel->Button_Href("Sil","nedmin/netting/islem.php?urunfavoridenkaldir=ok&favoriler_id=".$uruncek['favoriler_id'],"danger","Bu Favori ürünü silmek istiyormusunuz? İşlem geri alınamaz..."); 
