...
$siparissor=$faturadbservices->IadeKullaniciFaturaSiparisOne();
$siparissor2=$faturadbservices->IadeKullaniciFaturaSiparisSecond();
...
while($sipariscek=$faturadbservices->vericek($siparissor)) {
    ...
    $iadecek=$faturadbservices->IadeListele($_GET['siparis_id']);
}

$pdf->Write(10,turkce('Bu Fatura '.$iadecek['iade_turu'].' Faturası amacıyla '.$iadecek['iade_tarihi']." tarihinde düzenlenmiştir."));
$pdf->Ln(); 
...
$pdf->Ln(); 
$pdf->Write(10,turkce('Açıklama: '));
$aciklama=strip_tags ($iadecek['iade_aciklama']);
$pdf->Write(10,$aciklama);
