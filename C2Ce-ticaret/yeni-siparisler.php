            ...
            <div class="personal-info inner-page-padding"> 
             ...
             <table class="table table-striped">
              ...
              <tbody>
                ...
                <?php 
                $siparissor=$dbservice->yenisiperisgetir();
                $say=0;
                ...
                while($sipariscek=$dbservice->vericek($siparissor)) { 
                 ...
                 $total=$dbservice->yenisiparistotalHesapla($sipariscek);
                  ...
                  <tr>
                    ...
                    <?php 
                    echo "<td>";
                    $formpanel->Button_Href("Detay","yeni-siparisler-detay?kullanici_id=".$sipariscek['k_id']."&siparis_zaman=".$siparislerim->get_siparis_zaman()."&siparis_id=".$siparislerim->get_siparis_id(),"primary");
                    echo "</td>";
                    echo "<td>";
