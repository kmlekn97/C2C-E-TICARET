...
$kullanicilarim=$dbservice->kullanicilistesiMesaj();
        ...
        <div class="settings-details tab-content">
          <div class="tab-pane fade active in" id="Personal">
            ...
            <div class="personal-info inner-page-padding"> 
              ...
              <input type="hidden" name="kullanici_gel" value="<?php echo htmlspecialchars($_GET['kullanici_gel']) ?>">

              <?php $formpanel->Button("update-btn","mesajgonder","login-update","Mesaj Gönder"); ?>
